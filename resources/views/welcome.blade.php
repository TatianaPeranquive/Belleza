...
<div class="relative">
    ...
    <body class="overflow-x-hidden">
        ...
        <section id="home" class="h-screen flex justify-center items-center text-4xl bg-black text-white">
            <!-- Imagen -->
            <video src="EspejoPortada.mp4" controls poster="EspejoPortada.png"
        ...
        <section id="work" class="flex  justify-center items-center text-4xl bg-white text-black">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto items-center">
                <!-- Texto (centrado siempre) -->
                <div class="div2 text-center space-y-4">
                    <p class="text-lg md:text-xl max-w-prose mx-auto italic"> Había una vez una mujer que le preguntó al espejo
        ...
        <section id="about3" class="flex  justify-center items-center text-4xl bg-white text-black">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto items-center">
                <!-- Texto (centrado siempre) -->
                <div class="div2 text-center space-y-4">
        ...
        <section id="contact4" class="py-20 flex justify-center items-center text-4xl bg-white text-black">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto items-center">
        ...
        <section id="about4" class="flex  justify-center items-center text-4xl bg-white text-black">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto items-center">
                <!-- Texto (centrado siempre) -->
                <div class="div2 text-center space-y-4">
                <!-- Respuesta -->
                <div class="div1 flex justify-center">
                <p id="respuesta2" class="text-lg md:text-xl max-w-prose mx-auto"></p>
                </div>
                    <p class="text-lg md:text-xl max-w-prose mx-auto ">
        ...
        <section id="contact3" class="py-10 flex justify-center items-center text-4xl bg-white text-black">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto items-center">
            ...
            <ul id="opciones1" class="flex justify-center gap-4 w-full max-w-6xl">
                <li class="flex-1">
                <button type="button"
                    class="opcion block w-full text-center px-3 py-1 rounded border font-bold text-lg hover:underline">
                    UN POCO
                </button>
                </li>
                <li class="flex-1">
            ...
            <div class="div2 text-center space-y-4">
            <p id="respuesta" class="text-lg md:text-xl max-w-prose mx-auto italic text-gray-700">
        ...
        <section id="contact4" class=" py-10 flex justify-center items-center text-4xl bg-white text-black">
            <div class="text-center ">
                ...
                <br>
                <p class="text-lg md:text-xl max-w-prose mx-auto ">
                    Una que abarque varios puntos de la belleza, mi propuesta es pasar de lo bueno y lo malo y adentrarnos a un
        ...
        <section id="contact5" class="flex justify-center items-center text-4xl bg-white text-black">
            <div class="text-center ">
                <img src="Menu_espejos.png" alt=" " class="max-h-[500px] object-contain">
            </div>
        </section>
        <br><br><br>
        <script>
            ...
            opciones2.forEach(op => {
                ...
                respuesta2.textContent = `${op.textContent.trim()}. Interesante.`;
                });
            });
