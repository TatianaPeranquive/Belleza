...
Ajusta : h-[140px] / h-[160px] / h-[180px] --}}
    ...
    <div class="max-w-6xl mx-auto">
                ...
                @php
                    ...
                    if (is_array($bruto)) {
                        ...
                        if (isset($bruto[0]) && is_array($bruto[0])) {
                            ...
                            // Elegimos qué campo mostrar de cada autora (ajusta si tu llave no es "nombre")
                        ...
                        // Caso 2: array plano (una persona con lista simple)
                        else {
        ...
        <div class="w-full fade-in" style="
            ...
            <p class="text-xl mb-12 leading-relaxed" style="color:#34113F;">
                ...
                binarias
                y que, por ello y por su historia, es paradójica. Esto ocurre porque a medida que pasamos por los hitos,
                aquello que nos dicen sobre la belleza es muy diferente entre sí. Por ejemplo: "tienes que cuidarte,
                pero
                tienes que lucir natural"; "no juzgues a nadie por su apariencia, pero ellos te van a juzgar por ella",
                etc.
                Con estos dictámenes en la cabeza, muchas de las mujeres toman un camino y una posición que parece firme
                y
                tiene que ser coherente para contrarrestar la presión y encontrar paz mental. El objetivo del proyecto
                no es
